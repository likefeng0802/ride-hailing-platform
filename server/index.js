...
app.post('/api/booking-email', async (req, res) => {
  try {
    ...
    const to = (localSMTP && localSMTP.to) || process.env.MAIL_TO || 'leeexecutivetransport@gmail.com';
...
app.post('/api/booking-email/test', async (req, res) => {
  try {
    const to = (req.body && req.body.to) || (localSMTP && localSMTP.to) || 'leeexecutivetransport@gmail.com';
